...
namespace FishyFlip.Xrpc.Lexicon.Com.Atproto.Moderation
{
    ...
    public abstract class ModerationController : ControllerBase
    {
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Com.Atproto.Moderation.CreateReportOutput>, BadRequest>> CreateReportAsync (string reasonType, ATObject subject, string? reason = default, CancellationToken cancellationToken = default);
    }
}
