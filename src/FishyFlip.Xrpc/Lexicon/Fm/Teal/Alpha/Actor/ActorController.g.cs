...
namespace FishyFlip.Xrpc.Lexicon.Fm.Teal.Alpha.Actor
{
    ...
    public abstract class ActorController : ControllerBase
    {
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Fm.Teal.Alpha.Actor.GetProfileOutput>, BadRequest>> GetProfileAsync ([FromQuery] FishyFlip.Models.ATIdentifier actor, CancellationToken cancellationToken = default);
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Fm.Teal.Alpha.Actor.GetProfilesOutput>, BadRequest>> GetProfilesAsync ([FromQuery] List<FishyFlip.Models.ATIdentifier> actors, CancellationToken cancellationToken = default);
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Fm.Teal.Alpha.Actor.SearchActorsOutput>, BadRequest>> SearchActorsAsync ([FromQuery] string q, [FromQuery] int? limit = 0, [FromQuery] string? cursor = default, CancellationToken cancellationToken = default);
    }
}
