...
namespace FishyFlip.Xrpc.Lexicon.Buzz.Bookhive
{
    ...
    public abstract class BookhiveController : ControllerBase
    {
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Buzz.Bookhive.GetBookOutput>, BadRequest>> GetBookAsync ([FromQuery] string id, CancellationToken cancellationToken = default);
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Buzz.Bookhive.GetProfileOutput>, BadRequest>> GetProfileAsync ([FromQuery] string? did = default, [FromQuery] string? handle = default, CancellationToken cancellationToken = default);
        ...
        public abstract Task<Results<Ok<FishyFlip.Lexicon.Buzz.Bookhive.SearchBooksOutput>, BadRequest>> SearchBooksAsync ([FromQuery] string q, [FromQuery] int? limit = 25, [FromQuery] int? offset = 0, [FromQuery] string? id = default, CancellationToken cancellationToken = default);
    }
}
