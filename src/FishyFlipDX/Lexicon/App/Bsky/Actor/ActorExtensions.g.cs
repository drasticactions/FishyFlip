...
namespace FishyFlip
{
    ...
    public static class BlueskyActorExtensions
    {
        ...
        /// </summary>
        public static Task<Result<CreateRecordOutput?>> CreateProfileRecordAsync(this FishyFlip.Lexicon.App.Bsky.Actor.BlueskyActor atp, FishyFlip.Models.ATIdentifier repo, FishyFlip.Lexicon.App.Bsky.Actor.Profile record, string? rkey = default, bool? validate = default, string? swapCommit = default, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static Task<Result<PutRecordOutput?>> PutProfileRecordAsync(this FishyFlip.ATProtocol atp, FishyFlip.Models.ATIdentifier repo, string rkey, FishyFlip.Lexicon.App.Bsky.Actor.Profile record, bool? validate = default, string? swapRecord = default, string? swapCommit = default, CancellationToken cancellationToken = default)
        {
