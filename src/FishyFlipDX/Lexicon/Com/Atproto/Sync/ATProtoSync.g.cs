...
namespace FishyFlip.Lexicon.Com.Atproto.Sync
{
    ...
    public sealed class ATProtoSync
    {
        ...
        /// </summary>
        public Task<Result<Success?>> GetCheckoutAsync (FishyFlip.Models.ATDid did, CancellationToken cancellationToken = default)
        {
            return atp.GetCheckoutAsync(did, cancellationToken);
        }
        ...
        /// </summary>
        public Task<Result<Success?>> GetRecordAsync (FishyFlip.Models.ATDid did, string collection, string rkey, CancellationToken cancellationToken = default)
        {
            return atp.GetRecordAsync(did, collection, rkey, cancellationToken);
        }
        ...
        /// </summary>
        public Task<Result<Success?>> GetRepoAsync (FishyFlip.Models.ATDid did, string? since = default, CancellationToken cancellationToken = default)
        {
            return atp.GetRepoAsync(did, since, cancellationToken);
        }
