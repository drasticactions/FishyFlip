...
namespace FishyFlip.Lexicon.Chat.Bsky.Convo
{
    public partial class DeleteMessageForSelfInput : ATObject
    {
        ...
        {
            return JsonSerializer.Serialize<Chat.Bsky.Convo.DeleteMessageForSelfInput>(this, (JsonTypeInfo<Chat.Bsky.Convo.DeleteMessageForSelfInput>)SourceGenerationContext.Default.ChatBskyConvoDeleteMessageForSelfInput)!;
        }

        public static DeleteMessageForSelfInput FromJson(string json)
        {
            return JsonSerializer.Deserialize<Chat.Bsky.Convo.DeleteMessageForSelfInput>(json, (JsonTypeInfo<Chat.Bsky.Convo.DeleteMessageForSelfInput>)SourceGenerationContext.Default.ChatBskyConvoDeleteMessageForSelfInput)!;
        }
    }
}
