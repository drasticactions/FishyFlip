...
namespace FishyFlip.Lexicon.Social.Psky.Richtext
{
    ...
    public partial class ByteSlice : ATObject, ICBOREncodable<ByteSlice>, IJsonEncodable<ByteSlice>, IParsable<ByteSlice>
    {
        ...
        {
            return JsonSerializer.Serialize(this, (JsonTypeInfo<FishyFlip.Lexicon.Social.Psky.Richtext.ByteSlice>)SourceGenerationContext.Default.SocialPskyRichtextByteSlice);
        }

        public override byte[] ToUtf8Json()
        {
            return JsonSerializer.SerializeToUtf8Bytes(this, (JsonTypeInfo<FishyFlip.Lexicon.Social.Psky.Richtext.ByteSlice>)SourceGenerationContext.Default.SocialPskyRichtextByteSlice);
        }
        ...
        {
            return JsonSerializer.Deserialize<ByteSlice>(s, (JsonTypeInfo<ByteSlice>)SourceGenerationContext.Default.SocialPskyRichtextByteSlice)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out ByteSlice result)
        {
            result = JsonSerializer.Deserialize<ByteSlice>(s, (JsonTypeInfo<ByteSlice>)SourceGenerationContext.Default.SocialPskyRichtextByteSlice);
            return result != null;
        }
    }
}
