...
namespace FishyFlip.Lexicon.My.Skylights
{
    ...
    public static class ATProtoSkylightsExtensions
    {
        ...
        public static Task<Result<CreateRecordOutput?>> CreateRelAsync(this FishyFlip.ATProtocol atp, My.Skylights.Rel record, string? rkey = default, bool? validate = default, string? swapCommit = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="swapCommit"></param>
        /// <param name="cancellationToken"></param>
        public static Task<Result<CreateRecordOutput?>> CreateRelAsync(this FishyFlip.ATProtocol atp, ATObject? item, My.Skylights.Rating? rating = default, My.Skylights.Note? note = default, List<DateTime>? finishedAt = default, string? rkey = default, bool? validate = default, string? swapCommit = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="swapCommit"></param>
        /// <param name="cancellationToken"></param>
        public static Task<Result<PutRecordOutput?>> PutRelAsync(this FishyFlip.ATProtocol atp, FishyFlip.Models.ATIdentifier repo, string rkey, My.Skylights.Rel record, bool? validate = default, string? swapRecord = default, string? swapCommit = default, CancellationToken cancellationToken = default)
        {
