...
{
    public partial class RepoView : ATObject, ICBOREncodable<RepoView>, IJsonEncodable<RepoView>, IParsable<RepoView>
    {
        ...
        /// <inheritdoc/>
        public static RepoView Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<RepoView>(s, (JsonTypeInfo<RepoView>)SourceGenerationContext.Default.ToolsOzoneModerationRepoView)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out RepoView result)
        {
            result = JsonSerializer.Deserialize<RepoView>(s, (JsonTypeInfo<RepoView>)SourceGenerationContext.Default.ToolsOzoneModerationRepoView);
            return result != null;
        }
    }
}
