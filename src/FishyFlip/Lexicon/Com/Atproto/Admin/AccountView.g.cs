...
namespace FishyFlip.Lexicon.Com.Atproto.Admin
{
    public partial class AccountView : ATObject, ICBOREncodable<AccountView>, IJsonEncodable<AccountView>
    {
        ...
        {
            return JsonSerializer.Serialize(this, (JsonTypeInfo<FishyFlip.Lexicon.Com.Atproto.Admin.AccountView>)SourceGenerationContext.Default.ComAtprotoAdminAccountView);
        }

        public override byte[] ToUtf8Json()
        {
            return JsonSerializer.SerializeToUtf8Bytes(this, (JsonTypeInfo<FishyFlip.Lexicon.Com.Atproto.Admin.AccountView>)SourceGenerationContext.Default.ComAtprotoAdminAccountView);
        }

        public static new AccountView FromJson(string json)
        {
