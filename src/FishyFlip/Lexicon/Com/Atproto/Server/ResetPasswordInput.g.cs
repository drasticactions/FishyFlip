...
{
    public partial class ResetPasswordInput : ATObject, ICBOREncodable<ResetPasswordInput>, IJsonEncodable<ResetPasswordInput>, IParsable<ResetPasswordInput>
    {
        ...
        /// <inheritdoc/>
        public static ResetPasswordInput Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<ResetPasswordInput>(s, (JsonTypeInfo<ResetPasswordInput>)SourceGenerationContext.Default.ComAtprotoServerResetPasswordInput)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out ResetPasswordInput result)
        {
            result = JsonSerializer.Deserialize<ResetPasswordInput>(s, (JsonTypeInfo<ResetPasswordInput>)SourceGenerationContext.Default.ComAtprotoServerResetPasswordInput);
            return result != null;
        }
    }
}
