...
{
    public partial class PutRecordOutput : ATObject, ICBOREncodable<PutRecordOutput>, IJsonEncodable<PutRecordOutput>, IParsable<PutRecordOutput>
    {
        ...
        /// <inheritdoc/>
        public static PutRecordOutput Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<PutRecordOutput>(s, (JsonTypeInfo<PutRecordOutput>)SourceGenerationContext.Default.ComAtprotoRepoPutRecordOutput)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out PutRecordOutput result)
        {
            result = JsonSerializer.Deserialize<PutRecordOutput>(s, (JsonTypeInfo<PutRecordOutput>)SourceGenerationContext.Default.ComAtprotoRepoPutRecordOutput);
            return result != null;
        }
    }
}
