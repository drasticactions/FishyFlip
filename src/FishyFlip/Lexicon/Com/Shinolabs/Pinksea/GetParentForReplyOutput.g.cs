...
namespace FishyFlip.Lexicon.Com.Shinolabs.Pinksea
{
    public partial class GetParentForReplyOutput : ATObject
    {
        ...
        {
            return JsonSerializer.Serialize<Com.Shinolabs.Pinksea.GetParentForReplyOutput>(this, (JsonTypeInfo<Com.Shinolabs.Pinksea.GetParentForReplyOutput>)SourceGenerationContext.Default.ComShinolabsPinkseaGetParentForReplyOutput)!;
        }

        public static GetParentForReplyOutput FromJson(string json)
        {
            return JsonSerializer.Deserialize<Com.Shinolabs.Pinksea.GetParentForReplyOutput>(json, (JsonTypeInfo<Com.Shinolabs.Pinksea.GetParentForReplyOutput>)SourceGenerationContext.Default.ComShinolabsPinkseaGetParentForReplyOutput)!;
        }
    }
}
