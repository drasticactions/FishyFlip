...
{
    public partial class LogAcceptConvo : ATObject, ICBOREncodable<LogAcceptConvo>, IJsonEncodable<LogAcceptConvo>, IParsable<LogAcceptConvo>
    {
        ...
        /// <inheritdoc/>
        public static LogAcceptConvo Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<LogAcceptConvo>(s, (JsonTypeInfo<LogAcceptConvo>)SourceGenerationContext.Default.ChatBskyConvoLogAcceptConvo)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out LogAcceptConvo result)
        {
            result = JsonSerializer.Deserialize<LogAcceptConvo>(s, (JsonTypeInfo<LogAcceptConvo>)SourceGenerationContext.Default.ChatBskyConvoLogAcceptConvo);
            return result != null;
        }
    }
}
