...
namespace FishyFlip.Lexicon.Blue.Moji.Packs
{
    ...
    public partial class Pack : ATObject, ICBOREncodable<Pack>, IJsonEncodable<Pack>, IParsable<Pack>
    {
        ...
        {
            return JsonSerializer.Serialize(this, (JsonTypeInfo<FishyFlip.Lexicon.Blue.Moji.Packs.Pack>)SourceGenerationContext.Default.BlueMojiPacksPack);
        }

        public override byte[] ToUtf8Json()
        {
            return JsonSerializer.SerializeToUtf8Bytes(this, (JsonTypeInfo<FishyFlip.Lexicon.Blue.Moji.Packs.Pack>)SourceGenerationContext.Default.BlueMojiPacksPack);
        }

        public static new Pack FromJson(string json)
        {
