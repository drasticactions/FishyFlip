...
namespace FishyFlip.Lexicon.Pub.Leaflet.Richtext
{
    ...
    public partial class ByteSlice : ATObject, ICBOREncodable<ByteSlice>, IJsonEncodable<ByteSlice>, IParsable<ByteSlice>
    {
        ...
        public ByteSlice(long byteStart = default, long byteEnd = default)
        {
            ...
            this.Type = "pub.leaflet.richtext.facet#byteSlice";
        }
        ...
        public const string RecordType = "pub.leaflet.richtext.facet#byteSlice";

        public override string ToJson()
        {
            return JsonSerializer.Serialize(this, (JsonTypeInfo<FishyFlip.Lexicon.Pub.Leaflet.Richtext.ByteSlice>)SourceGenerationContext.Default.PubLeafletRichtextByteSlice);
        }

        public override byte[] ToUtf8Json()
        {
            return JsonSerializer.SerializeToUtf8Bytes(this, (JsonTypeInfo<FishyFlip.Lexicon.Pub.Leaflet.Richtext.ByteSlice>)SourceGenerationContext.Default.PubLeafletRichtextByteSlice);
        }

        public static new ByteSlice FromJson(string json)
        {
            return JsonSerializer.Deserialize<FishyFlip.Lexicon.Pub.Leaflet.Richtext.ByteSlice>(json, (JsonTypeInfo<FishyFlip.Lexicon.Pub.Leaflet.Richtext.ByteSlice>)SourceGenerationContext.Default.PubLeafletRichtextByteSlice)!;
        }
        ...
        {
            return JsonSerializer.Deserialize<ByteSlice>(s, (JsonTypeInfo<ByteSlice>)SourceGenerationContext.Default.PubLeafletRichtextByteSlice)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out ByteSlice result)
        {
            result = JsonSerializer.Deserialize<ByteSlice>(s, (JsonTypeInfo<ByteSlice>)SourceGenerationContext.Default.PubLeafletRichtextByteSlice);
            return result != null;
        }
    }
}
