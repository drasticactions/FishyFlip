...
{
    public partial class GetFeedOutput : ATObject, ICBOREncodable<GetFeedOutput>, IJsonEncodable<GetFeedOutput>, IParsable<GetFeedOutput>
    {
        ...
        /// <inheritdoc/>
        public static GetFeedOutput Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<GetFeedOutput>(s, (JsonTypeInfo<GetFeedOutput>)SourceGenerationContext.Default.AppBskyFeedGetFeedOutput)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out GetFeedOutput result)
        {
            result = JsonSerializer.Deserialize<GetFeedOutput>(s, (JsonTypeInfo<GetFeedOutput>)SourceGenerationContext.Default.AppBskyFeedGetFeedOutput);
            return result != null;
        }
    }
}
