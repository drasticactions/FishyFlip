...
namespace FishyFlip.Lexicon.App.Bsky.Actor
{
    public partial class FeedViewPref : ATObject, ICBOREncodable<FeedViewPref>, IJsonEncodable<FeedViewPref>
    {
        ...
        {
            return JsonSerializer.Serialize(this, (JsonTypeInfo<FishyFlip.Lexicon.App.Bsky.Actor.FeedViewPref>)SourceGenerationContext.Default.AppBskyActorFeedViewPref);
        }

        public override byte[] ToUtf8Json()
        {
            return JsonSerializer.SerializeToUtf8Bytes(this, (JsonTypeInfo<FishyFlip.Lexicon.App.Bsky.Actor.FeedViewPref>)SourceGenerationContext.Default.AppBskyActorFeedViewPref);
        }

        public static new FeedViewPref FromJson(string json)
        {
