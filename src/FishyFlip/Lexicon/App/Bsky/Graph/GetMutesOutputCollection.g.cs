...
namespace FishyFlip.Lexicon.App.Bsky.Graph
{
    ...
    public class GetMutesOutputCollection : ATObjectCollectionBase<FishyFlip.Lexicon.App.Bsky.Actor.ProfileView>, IAsyncEnumerable<FishyFlip.Lexicon.App.Bsky.Actor.ProfileView>
    {
        ...
        public override async Task<(IList<FishyFlip.Lexicon.App.Bsky.Actor.ProfileView> Posts, string Cursor)> GetRecordsAsync(int? limit = null, CancellationToken? token = default)
        {
            ...
            var (result, error) = await this.ATProtocol.GetMutesAsync(limit: limit, cursor: this.Cursor, cancellationToken: token.Value!);

            this.HandleATError(error);

            if (result == null || result.Mutes == null)
            {
