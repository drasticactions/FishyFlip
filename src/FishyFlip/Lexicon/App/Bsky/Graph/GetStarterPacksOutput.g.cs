...
{
    public partial class GetStarterPacksOutput : ATObject, ICBOREncodable<GetStarterPacksOutput>, IJsonEncodable<GetStarterPacksOutput>, IParsable<GetStarterPacksOutput>
    {
        ...
        /// <inheritdoc/>
        public static GetStarterPacksOutput Parse(string s, IFormatProvider? provider)
        {
            return JsonSerializer.Deserialize<GetStarterPacksOutput>(s, (JsonTypeInfo<GetStarterPacksOutput>)SourceGenerationContext.Default.AppBskyGraphGetStarterPacksOutput)!;
        }

        /// <inheritdoc/>
        public static bool TryParse(string? s, IFormatProvider? provider, out GetStarterPacksOutput result)
        {
            result = JsonSerializer.Deserialize<GetStarterPacksOutput>(s, (JsonTypeInfo<GetStarterPacksOutput>)SourceGenerationContext.Default.AppBskyGraphGetStarterPacksOutput);
            return result != null;
        }
    }
}
